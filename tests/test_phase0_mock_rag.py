#!/usr/bin/env python3
"""
Test Phase 0 Integration with Mock RAG System
Tests the complete agentic workflow with mock RAG data to avoid database connection issues.
"""
...
async def test_phase0_integration():
    """Test the complete Phase 0 integration with mock RAG system."""
    
    print("🚀 Testing Phase 0 Integration with Mock RAG System")
    print("=" * 60)
    ...
    try:
        ...
        print(f"\n🧪 Testing {len(test_queries)} queries with mock RAG system...")
        print("-" * 60)
        ...
        for i, query in enumerate(test_queries, 1):
            ...
            try:
                ...
                has_relevant_info = any(keyword in response_lower for keyword in [
                    "deductible", "copay", "covered", "doctor", "prescription", "network"
                ])
...
async def main():
    """Main test function."""
    print("🔧 Phase 0 Integration Test with Mock RAG System")
    print("=" * 60)
