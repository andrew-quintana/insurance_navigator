...
class SimpleWorkerTester:
    def __init__(self):
        ...
        self.auth_token = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiI5MzY1NTFiNi1iN2E0LTRkM2QtOWZlMC1hNDkxNzk0ZmQ2NjYiLCJlbWFpbCI6InRlc3RfdXNlckBleGFtcGxlLmNvbSIsImV4cCI6MTczNjQ0NDAwMH0.test_token"
