...
echo "  • TypeScript check:     cd ui && npm run type-check"
echo "  • Frontend build test:  cd ui && npm run build"
echo "  • Vercel deploy test:   cd ui && NODE_ENV=production npm run build"
echo "  • Stop services:        ./stop_local_dev.sh"
