...
Deno.test('Test Complete Document Processing Pipeline', async () => {
  ...
  try {
    ...
    const response = await fetch('http://127.0.0.1:54321/functions/v1/doc-processor', {
      method: 'POST',
      headers: {
        'Authorization': `Bearer ***REMOVED***.eyJpc3MiOiJzdXBhYmFzZS1kZW1vIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImV4cCI6MTk4MzgxMjk5Nn0.p2fuVDatv5iaDizrYVeg2Gx_U1utFdpwLHwkiZfsRxs`,
