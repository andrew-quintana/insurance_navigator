#!/usr/bin/env python3
"""
Quick test script for the vector retrieval tool with existing data.
"""
...
async def test_vector_tool():
    """Test the vector retrieval tool with known working data."""
    
    # Use known working combination from database
    doc_id = "d64bfbbe-ff7f-4b51-b220-a0fa20756d9d"
    user_id = "d64bfbbe-ff7f-4b51-b220-a0fa20756d9d"  # Same as doc_id for this data
