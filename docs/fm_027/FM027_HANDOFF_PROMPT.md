...
curl -H "apikey: [SERVICE_ROLE_KEY]" -H "Authorization: Bearer [SERVICE_ROLE_KEY]" "***REMOVED***/storage/v1/object/files/user/74a635ac-4bfe-4b6e-87d2-c0f54a366fbe/raw/5796784a_5e4390c2.pdf" -v
```
