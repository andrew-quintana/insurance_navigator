"""
Simplified Real API Integration Testing for Phase 3.5

This script tests basic real API functionality to identify what works and what doesn't.
"""
...
"""
        ...
        try:
            ...
            try:
                ...
                if any(keyword in error_str for keyword in ['file', 'path', 'format', 'validation']):
...
async def run_basic_tests():
    """Run basic real API tests."""
    logger.info("Starting basic real API integration testing...")
    ...
    logger.info("=" * 50)
    logger.info("TEST 1: Basic LlamaParse Connectivity")
    logger.info("=" * 50)
    results["basic_connectivity"] = await test_llamaparse_basic()
    
    # Test 2: Parse request (basic)
    logger.info("=" * 50)
    logger.info("TEST 2: Basic Parse Request")
    logger.info("=" * 50)
    ...
    # Print summary
    logger.info("=" * 50)
    logger.info("BASIC TESTING COMPLETE")
    logger.info("=" * 50)
...
async def main():
    """Main function."""
    logger.info("Starting Phase 3.5 Basic Real API Integration Testing")
    ...
    try:
        ...
        # Print results
        print("\n" + "=" * 60)
        print("PHASE 3.5 BASIC REAL API TESTING RESULTS")
        print("=" * 60)
        ...
        # Save results
        results_file = f"basic_real_api_test_results_{datetime.utcnow().strftime('%Y%m%d_%H%M%S')}.json"
